...
public class ChartUtilsTest {
  ...
  private static final String BASE_PATH =
      "/Users/administrator/Desktop/work-space/IDEA/java-utility-class/src/test/resources";
  ...
  public void cpkPpkTest() {
    ...
    CpkPpkChartUtils.process(
        "汽车核心制动盘厚度尺寸 CPK/PPK 过程能力综合看板 (5万条完美贴合版)",
        mockData,
        usl,
        lsl,
        0, // bins 传 0 激活代码内置的斯特基公式自适应分组
        outputPath,
        customWidth, // 注入自定义宽度
  ...
  public void standardScatterTest() {
    ...
    ScatterChartUtils.processStandardChart(
        "工龄与薪资关系分布散点图", "工作年限 (年)", "年薪 (万元)", dataset, outputPath, 800, 600);
  ...
  public void centerQuadrantScatterTest() {
    ...
    // 通过清晰的方法名直观调用中心对称十字版
    ScatterChartUtils.processCenterQuadrantChart(
        "模具成型中心点偏离度象限分析", "X方向偏差 (mm)", "Y方向偏差 (mm)", dataset, path, 800, 600);
  ...
  public void multiLevelDoubleRowSankeyTest() {
    ...
    SankeyChartUtils.processSankey(
        "新能源汽车全生命周期价值流向拓扑图 (Java原生双层折行版)", dataList, outputPath, width, height);
