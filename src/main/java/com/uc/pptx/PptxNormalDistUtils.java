...
public final class PptxNormalDistUtils {
  ...
  public static void process(
      XMLSlideShow ppt, Map<String, NormalDistConfig> configMap, String placeholderMark) {
  ...
  private static void createNormalDistributionChart(
      XMLSlideShow ppt, XSLFSlide slide, XSLFTextShape textShape, NormalDistConfig config)
      throws Exception {
    ...
    CTScatterChart ctScatterChart =
        chart.getCTChartSpace().getChart().getPlotArea().getScatterChartArray(0);
  ...
  private static void scanPlaceholders(
      XSLFShapeContainer container,
      Map<String, NormalDistConfig> configMap,
      String mark,
      Map<XSLFTextShape, NormalDistConfig> tasks) {
