...
public final class PptxImageUtils {
  ...
  public static void process(
      XMLSlideShow ppt, Map<String, String> imageMap, String imagePlaceholderMark) {
  ...
  /** 提取出的公共匹配与提取任务方法 */
  private static void checkAndAddTask(
      XSLFTextShape shape,
      String text,
      Map<String, String> imageMap,
      String imgMark,
  ...
  private static void replaceShapeWithImage(
      ...
      String imgPathOrUrl,
      Map<String, XSLFPictureData> cache)
      throws IOException {
    ...
    java.awt.geom.Rectangle2D.Double anchor =
        (java.awt.geom.Rectangle2D.Double) textShape.getAnchor();
    if (anchor == null) {
      return;
    }
  ...
  private static byte[] fetchImageBytes(String imgPathOrUrl) throws IOException {
    return imgPathOrUrl.startsWith("http")
        ? downloadNetworkImage(imgPathOrUrl)
        : readLocalImage(imgPathOrUrl);
  }
